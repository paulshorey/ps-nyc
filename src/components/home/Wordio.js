        ...
        <article className="full">
          ...
          <div className="description">
            <p>
              ...
              name suggestions engine in the industry. It doesn't just search. It actually generates new phrases using NLP! Also, an API to check availability of 100s of domains at a
              time.
