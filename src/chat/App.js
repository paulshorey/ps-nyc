		...
		if (this.state.closed) {
			...
			return (
				<Styled.App>
					...
					<p style={{color:"#999"}}>Here's a fun and quick code sample. Send a message. I will receive it immediately via SMS (Twilio). If I'm at my phone and text back, you'll get my reply. Otherwise, a loading animation where my reply would be. <a href="https://github.com/paulshorey/ps-api" target="_blank" rel="noopener noreferrer">Node.js</a> back-end <a href="https://github.com/paulshorey/ps" target="_blank" rel="noopener noreferrer">React</a> front-end (GitHub).</p>
