...
if ( $_POST['description'] ) {
	if ( $_POST['description'] === file_get_contents('newshows.html') ) {
		echo '<p style="padding-bottom:15px;color:blue;">No changes.</p>';
	} else if ( file_put_contents( 'newshows.html', $_POST['description'] ) ) {
...
<div style="margin-bottom:15px;">
    ...
    <input type="button" value="Reset" onclick="window.location.href = '/newshows.php';" />
</div>
<textarea name="description" style="width:100%;height:600px;">
<?= $_POST['description'] ? $_POST['description'] : file_get_contents('newshows.html'); ?>
</textarea>
</form>
</body>
</html>