...
if (useragent.indexOf("android") >= 0) {
  ...
  var browserdevice = "android";
  var browsermake = "google";
}
if (useragent.indexOf("iphone") >= 0) {
  var browsertype = "mobile";
  var browserdevice = "iphone";
  var browsermake = "apple";
  var res_instant = 1;
}
if (useragent.indexOf("ipod") >= 0) {
  var browsertype = "mobile";
  var browserdevice = "ipod";
  var browsermake = "apple";
  var res_instant = 1;
}
if (useragent.indexOf("ipad") >= 0) {
  var browsertype = "mobile";
  var browserdevice = "ipad";
  var browsermake = "apple";
}
if (
  useragent.indexOf("phone") >= 0 ||
    ...
    if (ready == 1) {
      ...
      if (arebio == 1) {
        ...
        switch ($(this).index()) {
          ...
          case 3:
            arebio = 1;
            $(".page.under .act").animate(
              { height: "37%", "margin-top": "39%" },
              1500,
              "easeInQuad"
            );
            $(".page.under .act img").animate(
              { "margin-left": "-25%" },
              1500,
              "easeInQuad"
            );
...
function curtain_down() {
  ...
  $("#stage_curtain").stop();
  $("#stage_curtain").animate(
    { height: window.h_image_size },
    actlength,
    "easeOutQuad"
  );
  curtainup = 0;
...
function frame_close() {
  ...
  setTimeout(
    "$('.page_frame').animate({'opacity':0}, 500, 'easeInQuad');",
    1500
  );
}
...
function act_start() {
  ...
  board_hide();
  back_hide();
  $(".page.under .act_four").animate(
    { height: "36%", "margin-top": "39.25%" },
    1000,
    "easeInQuad"
  );
  $(".page.under .act_one").animate(
    { height: "61.3%", "margin-top": "28%" },
    2000,
    "easeInQuad"
  );
  $(".page.under .act_one img").animate(
    { "margin-left": "-53%" },
    2000,
    "easeInQuad"
  );
  $(".page.under .act_two").animate(
    { height: "52.5%", "margin-top": "32%" },
    1500,
    "easeInQuad"
  );
  $(".page.under .act_two img").animate(
    { "margin-left": "-47%" },
    1500,
    "easeInQuad"
  );
  $(".page.under .act_three").animate(
    { height: "53.5%", "margin-top": "32.1%" },
    1500,
    "easeInQuad"
  );
  $(".page.under .act_three img").animate(
    { "margin-left": "-27%" },
    1000,
    "easeInQuad"
  );
  $(".page.under .act_six").animate(
    { height: "40%", "margin-top": "37.9%", "margin-left": "1.2%" },
    1000,
    "easeInQuad"
  );
  $(".page.under .act_six img").animate(
    { "margin-left": "-23%" },
    1000,
    "easeInQuad"
  );
  $(".page.under .act_five").animate(
    { height: "36%", "margin-top": "38.8%" },
    1000,
    "easeInQuad"
  );
