<?php /* Smarty version 2.6.22, created on 2010-07-14 15:49:17
         compiled from publisher/core/pages/editor+text1.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'publisher/core/pages/editor text1.html', 40, false),)), $this); ?>
...
<div id="middle">
	...
	<!-- FORM -->
    <form action="publisher/core/pages/editor text1.php" name="form_1" method="post" enctype="multipart/form-data">
...
" />
    <h5>Edit the main text in "<?php echo ((is_array($_tmp=$this->_tpl_vars['page']['name'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
"</h5>
    
    <!-- -->
    <div class="section">
      <p style="font-weight:bold;">
      <a href="javascript:return;" class="help">Title 1 </a><a href="javascript:return;" class="helpbox">
      Some of your webpages may display one, two or three titles. If left blank, the page name will be used.
      </a>
      </p>
    <input type="text" name="title1" style="width:80%;" value="<?php if ($this->_tpl_vars['post']['title1']): ?><?php echo $this->_tpl_vars['post']['title1']; ?>
...
<?php endif; ?>" />
    ...
    <div class="section">
      <p style="font-weight:bold;">
      <a href="javascript:return;" class="help">Text 1 </a><a href="javascript:return;" class="helpbox">
      This is the main body of text that's displayed in your webpage.
      </a>
      </p>
