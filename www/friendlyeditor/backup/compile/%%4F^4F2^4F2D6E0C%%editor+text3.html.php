<?php /* Smarty version 2.6.22, created on 2010-07-15 11:52:07
         compiled from publisher/core/pages/editor+text3.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'publisher/core/pages/editor text3.html', 40, false),)), $this); ?>
...
<div id="middle">
	...
	<!-- FORM -->
    <form action="publisher/core/pages/editor text3.php" name="form_1" method="post" enctype="multipart/form-data">
...
"</h5>
    ...
    <div class="section">
      ...
      <a href="javascript:return;" class="help">Title 3 </a><a href="javascript:return;" class="helpbox">
      Some of your webpages may display one, two or three titles.
      </a>
      </p>
    <input type="text" name="title3" style="width:80%;" value="<?php if ($this->_tpl_vars['post']['title3']): ?><?php echo $this->_tpl_vars['post']['title3']; ?>
...
<?php endif; ?>" />
    ...
    <div class="section">
      <p style="font-weight:bold;">
      <a href="javascript:return;" class="help">Text 3 </a><a href="javascript:return;" class="helpbox">
      This is the third body of text that will be displayed in your webpage.
      </a>
      </p>
    <textarea name="text3" style="width:100%;height:400px;">
	<?php if ($this->_tpl_vars['post']['text3']): ?><?php echo $this->_tpl_vars['post']['text3']; ?>
<?php else: ?><?php echo $this->_tpl_vars['page']['text3']; ?>
<?php endif; ?>
    </textarea>
    </div>
