<?php /* Smarty version 2.6.22, created on 2010-07-14 16:59:52
         compiled from publisher/core/items/editor+edititem.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'getitem', 'publisher/core/items/editor edititem.html', 43, false),array('function', 'getitems', 'publisher/core/items/editor edititem.html', 81, false),array('function', 'getpages', 'publisher/core/items/editor edititem.html', 459, false),array('modifier', 'date', 'publisher/core/items/editor edititem.html', 472, false),)), $this); ?>
...
<div id="middle">
	...
	<!-- FORM -->
    <form action="publisher/core/items/editor edititem.php" name="form_1" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id" id="id" value="<?php echo $this->_tpl_vars['item']['id']; ?>
" />
    <input type="hidden" name="type" id="type" value="<?php echo $this->_tpl_vars['page']['type']; ?>
" />
    <h5>Update the title, text, image, and other details about "<?php echo $this->_tpl_vars['item']['name']; ?>
".</h5>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['text3']; ?>
<?php endif; ?>" />
    </div>
...
?>
    <?php if ($this->_tpl_vars['val']['category'] != ""): ?><?php if ($this->_tpl_vars['item']['category'] == $this->_tpl_vars['val']['category']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['val']['category']; ?>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['price1']; ?>
<?php endif; ?>" />
        </p>
        <p>Qty 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['qty1']; ?>
<?php endif; ?>" />
        </p>
        <p>Ship 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['shp1']; ?>
<?php endif; ?>" />
        </p>
        </td>
        <td align="left" valign="top" class="button" style="padding:4px 12px 6px 6px;">
...
<?php else: ?><?php echo $this->_tpl_vars['item']['caption1']; ?>
<?php endif; ?>" />
...
/<?php echo $this->_tpl_vars['item']['image2']; ?>
" width="100%" /></div>
        <?php else: ?>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['price2']; ?>
<?php endif; ?>" />
        </p>
        <p>Qty 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['qty2']; ?>
<?php endif; ?>" />
        </p>
        <p>Ship 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['shp2']; ?>
<?php endif; ?>" />
        </p>
        </td>
        <td align="left" valign="top" class="button" style="padding:4px 12px 6px 6px;">
...
<?php else: ?><?php echo $this->_tpl_vars['item']['caption2']; ?>
<?php endif; ?>" />
        <div style="margin:4px 0 0 0;">
...
/<?php echo $this->_tpl_vars['item']['image3']; ?>
" width="100%" /></div>
        <?php else: ?>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['price3']; ?>
<?php endif; ?>" />
        </p>
        <p>Qty 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['qty3']; ?>
<?php endif; ?>" />
        </p>
        <p>Ship 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['shp3']; ?>
<?php endif; ?>" />
        </p>
        </td>
        <td align="left" valign="top" class="button" style="padding:4px 12px 6px 6px;">
...
<?php else: ?><?php echo $this->_tpl_vars['item']['caption3']; ?>
<?php endif; ?>" />
        <div style="margin:4px 0 0 0;">
...
/<?php echo $this->_tpl_vars['item']['image4']; ?>
" width="100%" /></div>
        <?php else: ?>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['price4']; ?>
<?php endif; ?>" />
        </p>
        <p>Qty 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['qty4']; ?>
<?php endif; ?>" />
        </p>
        <p>Ship 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['shp4']; ?>
<?php endif; ?>" />
        </p>
        </td>
        <td align="left" valign="top" class="button" style="padding:4px 12px 6px 6px;">
...
<?php else: ?><?php echo $this->_tpl_vars['item']['caption4']; ?>
<?php endif; ?>" />
        <div style="margin:4px 0 0 0;">
...
/<?php echo $this->_tpl_vars['item']['image5']; ?>
" width="100%" /></div>
        <?php else: ?>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['price5']; ?>
<?php endif; ?>" />
        </p>
        <p>Qty 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['qty5']; ?>
<?php endif; ?>" />
        </p>
        <p>Ship 
...
<?php else: ?><?php echo $this->_tpl_vars['item']['shp5']; ?>
<?php endif; ?>" />
        </p>
        </td>
        <td align="left" valign="top" class="button" style="padding:4px 12px 6px 6px;">
...
<?php else: ?><?php echo $this->_tpl_vars['item']['caption5']; ?>
<?php endif; ?>" />
        <div style="margin:4px 0 0 0;">
        ...
        <?php if ($this->_tpl_vars['item']['image6']): ?>
...
?>
        <?php if ($this->_tpl_vars['val']['name'] == $this->_tpl_vars['item']['page']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_tpl_vars['val']['name']; ?>
"><?php echo $this->_tpl_vars['val']['name']; ?>
<?php if ($this->_tpl_vars['val']['name'] == $this->_tpl_vars['item']['page']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_tpl_vars['val']['name']; ?>
"><?php echo $this->_tpl_vars['val']['name']; ?>
<?php if ($this->_tpl_vars['val']['name'] == $this->_tpl_vars['item']['page']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_tpl_vars['val']['name']; ?>
"><?php echo $this->_tpl_vars['val']['name']; ?>
<option <?php if ($this->_tpl_vars['val']['name'] == $this->_tpl_vars['item']['page']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_tpl_vars['val']['name']; ?>
"><?php echo $this->_tpl_vars['val']['name']; ?>
</option>
    <?php endforeach; endif; unset($_from); ?>
    </select>
...
<?php else: ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['date'])) ? $this->_run_mod_handler('date', true, $_tmp, 'm/d/Y') : smarty_modifier_date($_tmp, 'm/d/Y')); ?>
<?php endif; ?>" /></p>
    </div>
    </div>
...
<?php else: ?><?php echo $this->_tpl_vars['item']['text1']; ?>
<?php endif; ?></textarea>
    </div>
    
    <div class="section" style="cursor:hand;cursor:pointer;" onClick="$('#moretexts').show('slow');$(this).hide('slow');">
      <p style="font-weight:bold;">
...
<?php else: ?><?php echo $this->_tpl_vars['item']['text2']; ?>
<?php endif; ?></textarea>
    </div>
    </div>
