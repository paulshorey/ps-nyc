<?php /* Smarty version 2.6.22, created on 2010-07-14 15:50:56
         compiled from publisher/core/pages/editor+editpage.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'getfiles', 'publisher/core/pages/editor editpage.html', 76, false),)), $this); ?>
...
<div id="middle">
	...
	<!-- FORM -->
    <form action="publisher/core/pages/editor editpage.php" name="form_1" method="post" enctype="multipart/form-data">
...
" />
    <h5>Edit your page here, try out some different layouts.</h5>
    ...
    <input type="hidden" name="oldname" value="<?php echo $this->_tpl_vars['page']['name']; ?>
" />
...
<?php elseif ($this->_tpl_vars['page']['title1']): ?><?php echo $this->_tpl_vars['page']['title1']; ?>
...
<?php elseif ($this->_tpl_vars['page']['title3']): ?><?php echo $this->_tpl_vars['page']['title3']; ?>
<?php endif; ?>" /></p>
    </div>
    </div>
...
?>
        <option <?php if ($this->_tpl_vars['page']['type'] == $this->_tpl_vars['val']): ?>selected="selected"<?php endif; ?> value="<?php echo $this->_tpl_vars['val']; ?>
"><?php echo $this->_tpl_vars['val']; ?>
    ...
    <select name="menu">
    <option value="1" <?php if ($this->_tpl_vars['page']['menu'] == '1'): ?>selected="selected"<?php endif; ?>>Main menu</option>
    <option value="2" <?php if ($this->_tpl_vars['page']['menu'] == '2'): ?>selected="selected"<?php endif; ?>>Second menu</option>
    <option value="hidden" <?php if ($this->_tpl_vars['page']['menu'] == 'hidden'): ?>selected="selected"<?php endif; ?>>Hidden (link only)</option>
    </select>
    </div>
    ...
    <select name="orderby">
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'name asc'): ?>selected="selected"<?php endif; ?> value="name asc">name asc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'name desc'): ?>selected="selected"<?php endif; ?> value="name desc">name desc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'date asc'): ?>selected="selected"<?php endif; ?> value="date asc">date asc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'date desc'): ?>selected="selected"<?php endif; ?> value="date desc">date desc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'page asc'): ?>selected="selected"<?php endif; ?> value="page asc">page asc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'page desc'): ?>selected="selected"<?php endif; ?> value="page desc">page desc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'price1 asc'): ?>selected="selected"<?php endif; ?> value="price1 asc">price asc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'price1 desc'): ?>selected="selected"<?php endif; ?> value="price1 desc">price desc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'category asc'): ?>selected="selected"<?php endif; ?> value="category asc">category asc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'category desc'): ?>selected="selected"<?php endif; ?> value="category desc">category desc</option>
    <option <?php if ($this->_tpl_vars['page']['orderby'] == 'placement asc'): ?>selected="selected"<?php endif; ?> value="placement asc">placement asc</option>
    </select>
    </div>
...
<?php else: ?><?php echo $this->_tpl_vars['page']['text1']; ?>
<?php endif; ?>
    </textarea>
    </div>
